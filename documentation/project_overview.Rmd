...
From this modelling exercise, it seems clear that species can have a strong influence on SANPP in a patch in several different ways:

+ 1. Low relative abundance species can have very high RGRs and a long growing season.

+ 2. High relative abundance species can have very low RGRs and a long growing season.

+ 3. High relative abundance species can have very high RGRs and a short growing season

+ 4. High relative abundance species can have very high RGRs and a long growing season (i.e. the Darwinian demon)

The problem with trying to predict SANPP using simply the community weighted RGR is that it cannot distinguish between all these different potential conditions. Rather, it simply assumes that SANPP is determined by the most abundant RGR value in the community rather than accounting for phenology and how this can influence which species contribute strongly to SANPP.
